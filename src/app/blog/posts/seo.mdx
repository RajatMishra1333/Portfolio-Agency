---
title: "SEO settings for AllCreates"
summary: "Manage your AllCreates's SEO settings."
...
AllCreates automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

AllCreates automatically generates schema tags for your pages based on the `content.js` file.
